...
// Rate limiting (excluir rutas de maestra y búsqueda de items)
app.use((req, res, next) => {
  if (req.path.startsWith('/api/maestra') || req.path.startsWith('/api/items/barcode')) {
    return next(); // Saltar rate limiter para rutas críticas de operación
  }
